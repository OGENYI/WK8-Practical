...
* Note that the topic name must be all lower case. e.g. a topic should look like this ossonts/feeds/iotled and not like this ossonts/Feeds/iotLED.
...
void setup()
{
  ...
  WiFi.begin(ssid, pass);  // Start the connection attempt
